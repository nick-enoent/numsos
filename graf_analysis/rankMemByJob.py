...
class rankMemByJob(Analysis):
    def __init__(self, cont, start, end, schema='meminfo'):
        self.schema = schema
        self.cont = cont
        self.start = start
        self.end = end
    ...
    def job_summary(self, job_id):
        ...
        memUsedRatio = self.mem_used_ratio()
    ...
    def get_high_mem(self, threshold):
    ...
    def get_low_mem(self, threshold):
    ...
    def get_idle_high_mem(self, threshold):
    ...
    def get_idle_low_mem(self, threshold):
